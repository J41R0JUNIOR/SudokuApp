...
enum NavigationContentViewCoordinator: View{
    ...
    case sudokuNumbers(number: Binding<Int>, correctNumber: Binding<Int>, maxQtd: Binding<Int>, actualQtd: Binding<Int>/*, games: Binding<GameBoard>*/)
    ...
    var body: some View {
        ...
        case .sudokuNumbers(number: let number, correctNumber: let correctNumber, maxQtd: let maxQtd, actualQtd: let actualQtd/*, games: let games*/):
            SudokuKeyboard(selectedNumber: number, correctNumber: correctNumber, maxQtd: maxQtd, actualQtd: actualQtd/*, games: games*/)

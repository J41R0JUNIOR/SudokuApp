...
enum NavigationContentViewCoordinator: View{
    ...
    case sudokuNumbers(number: Binding<Int>, correctNumber: Binding<Int>, maxQtd: Binding<Int>, actualQtd: Binding<Int>, showAlert: Binding<Bool>)
    ...
    var body: some View {
        ...
        case .sudokuNumbers(number: let number, correctNumber: let correctNumber, maxQtd: let maxQtd, actualQtd: let actualQtd, let showAlert):
            SudokuKeyboard(selectedNumber: number, correctNumber: correctNumber, maxQtd: maxQtd, actualQtd: actualQtd, showAlert: showAlert)
